...
> [!warning]
>
>[OVH Mail Migrator](https://docs.ovh.com/us/es/microsoft-collaborative-solutions/exchange-migracion-de-cuentas-correo-ovh-mail-migrator/) permite migrar los mensajes de un servidor de correo a otro.</br>
>Si su correo solo se guarda en local (configuración en POP o archivo en local), puede realizar un [exportar desde su cliente de correo](https://docs.ovh.com/us/es/emails/migrar-sus-direcciones-de-correo-manualmente/), y a continuación [importar su fichero PST a través de OMM](https://docs.ovh.com/us/es/microsoft-collaborative-solutions/exchange-migracion-de-cuentas-correo-ovh-mail-migrator/#realizar-una-migracion-mediante-archivo) o [importar directamente desde su cliente de correo](https://docs.ovh.com/us/es/emails/migrar-sus-direcciones-de-correo-manualmente/).
