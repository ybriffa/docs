...
Go to [your account](https://eu.console.webpaas.ovhcloud.com), click on the small wheel next to you project's name and click on edit.

![Edit Plan](images/edit-plan.png "0.3")
...
![Edit Plan](images/billing-plan-upgrade.png "0.6")
...
![Edit Plan Choose](images/settings-upgrade-plan.png "0.6")
...
It's strongly recommended that you set up an [API token](../development-cli/api-tokens) and install the CLI
to define [an automatic backup](../administration-backup-and-restore#automated-backups) cron task.
